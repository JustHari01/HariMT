...
public class AsyncConfigFabric {
    ...
    public static void saveConfig() {
        ...
        CONFIG.setComment(disabled.getKey(),
        ...
        CONFIG.setComment(paraMax.getKey(),
        ...
        CONFIG.set(synchronizedEntities.getKey(),
                synchronizedEntities.getValue().stream().map(ResourceLocation::toString).toList());
        ...
        CONFIG.setComment(enableAsyncSpawn.getKey(),
