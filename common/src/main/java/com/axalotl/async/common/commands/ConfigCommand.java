...
public class ConfigCommand {
        public static LiteralArgumentBuilder<CommandSourceStack> registerConfig(
                ...
                return root.then(literal("config")
                                .then(literal("toggle").requires(cmdSrc -> cmdSrc.hasPermission(4)).executes(cmdCtx -> {
                                        ...
                                        MutableComponent message = prefix.copy()
                                                        .append(Component.literal("Async is now ").withStyle(
                                                                        style -> style.withColor(ChatFormatting.WHITE)))
                                                        .append(Component
                                                                        .literal(AsyncConfig.disabled.getValue()
                                                                                        ? "disabled"
                                                                                        : "enabled")
                                ...
                                .then(literal("synchronizedEntities")
                                                ...
                                                .executes(cmdCtx -> {
                                                        Set<ResourceLocation> currentValue = AsyncConfig.synchronizedEntities
                                                                        .getValue();
                                                        MutableComponent message = prefix.copy().append(Component
                                                                        .literal("Synchronized Entities: ")
                                                                        .withStyle(style -> style.withColor(
                                                                                        ChatFormatting.WHITE)));
                                                        if (currentValue.isEmpty()) {
                                                                message.append(Component
                                                                                .literal("No entities synchronized.")
                                                                                .withStyle(style -> style.withColor(
                                                                                                ChatFormatting.RED)));
                                                        } else {
                                                                ...
                                                                for (ResourceLocation entity : currentValue) {
                                                                        message.append(Component.literal("- ")
                                                                                        ...
                                                                                        .append(Component.literal(entity
                                                                                                        .toString())
                                                                                                        .withStyle(style -> style
                                                ...
                                                .then(literal("add")
                                                                .then(Commands.argument("entity",
                                                                                ...
                                                                                .executes(cmdCtx -> {
                                                                                        ResourceLocation id = ResourceLocationArgument
                                                                                                        .getId(cmdCtx, "entity");
                                                                                        if (AsyncConfig.synchronizedEntities
                                                                                                        .getValue()
                                                                                                        .contains(id)) {
                                                                                                MutableComponent message = prefix
                                                                                                                .copy()
                                                                                                                .append(Component
                                                                                                                                .literal("Error entity class ")
                                                                                                                                .withStyle(style -> style
                                                                                                                ...
                                                                                                                .append(Component
                                                                                                                                ...
                                                                                                                                .withStyle(style -> style
                                                                                                                                                .withColor(ChatFormatting.RED)))
                                                                                                                .append(Component
                                                                                                                                .literal(" is already synchronized.")
                                                                                                                                .withStyle(style -> style
                                                                                                                                                .withColor(ChatFormatting.RED)));
                                                                                                cmdCtx.getSource()
                                                                                                                .sendSuccess(() -> message,
                                                                                        ...
                                                                                        MutableComponent message = prefix
                                                                                                        ...
                                                                                                        .append(Component
                                                                                                                        ...
                                                                                                                        .withStyle(style -> style
                                                                                                                                        .withColor(ChatFormatting.GREEN)))
                                                                                                        .append(Component
                                                                                                                        .literal(" has been added to the synchronized list.")
                                                                                                                        .withStyle(style -> style
                                                                                                                                        .withColor(ChatFormatting.WHITE)));
                                                ...
                                                .then(literal("remove")
                                                                .then(Commands.argument("entity",
                                                                                ...
                                                                                .suggests((context, builder) -> {
                                                                                        AsyncConfig.synchronizedEntities
                                                                                                        .getValue()
                                                                                                        .forEach(id -> builder
                                                                                                                        .suggest(id.toString()));
                                                                                ...
                                                                                .executes(cmdCtx -> {
                                                                                        ResourceLocation identifier = cmdCtx
                                                                                                        .getArgument("entity",
                                                                                                ...
                                                                                                MutableComponent message = prefix
                                                                                                                ...
                                                                                                                .append(Component
                                                                                                                                ...
                                                                                                                                .withStyle(style -> style
                                                                                                                                                .withColor(ChatFormatting.RED)))
                                                                                                                .append(Component
                                                                                                                                .literal(" is not in the synchronized list.")
                                                                                                                                .withStyle(style -> style
                                                                                                                                                .withColor(ChatFormatting.RED)));
                                                                                                cmdCtx.getSource()
                                                                                                                .sendSuccess(() -> message,
                                                                                        ...
                                                                                        MutableComponent message = prefix
                                                                                                        ...
                                                                                                        .append(Component
                                                                                                                        ...
                                                                                                                        .withStyle(style -> style
                                                                                                                                        .withColor(ChatFormatting.GREEN)))
                                                                                                        .append(Component
                                                                                                                        .literal(" has been removed from synchronized list.")
                                                                                                                        .withStyle(style -> style
                                                                                                                                        .withColor(ChatFormatting.WHITE)));
                                                                                        cmdCtx.getSource().sendSuccess(
                                                                                                        () -> message,
                                ...
                                .then(literal("setAsyncEntitySpawn").requires(cmdSrc -> cmdSrc.hasPermission(4))
                                                .executes(cmdCtx -> {
                                                        ...
                                                        MutableComponent message = prefix.copy().append(Component
                                                                        .literal("Current value of async entity spawn: ")
                                                                        .withStyle(style -> style.withColor(
                                                                                        ChatFormatting.WHITE)))
                                                                        .append(Component
                                                ...
                                                .then(argument("value", BoolArgumentType.bool()).executes(cmdCtx -> {
                                                        ...
                                                        PlatformEvents.getInstance().saveConfig();
                                                        MutableComponent message = prefix.copy().append(Component
                                                                        .literal("Entity move sync set to ")
                                                                        .withStyle(style -> style.withColor(
                                                                                        ChatFormatting.WHITE)))
                                ...
                                .then(literal("setAsyncRandomTicks").requires(cmdSrc -> cmdSrc.hasPermission(4))
                                                .executes(cmdCtx -> {
                                                        boolean currentValue = AsyncConfig.enableAsyncRandomTicks
                                                                        .getValue();
                                                        MutableComponent message = prefix.copy().append(Component
                                                                        .literal("Current value of async random ticks: ")
                                                                        .withStyle(style -> style.withColor(
                                                                                        ChatFormatting.WHITE)))
                                                                        .append(Component
                                                                                        .literal(String.valueOf(
                                                ...
                                                .then(Commands.argument("value", BoolArgumentType.bool())
                                                                .executes(cmdCtx -> {
                                                                        boolean value = BoolArgumentType.getBool(cmdCtx,
                                                                                        "value");
                                                                        ...
                                                                        MutableComponent message = prefix.copy()
                                                                                        ...
                                                                                        .append(Component.literal(String
                                                                                                        ...
                                                                                                        .withStyle(style -> style
                                                                                                                        .withColor(ChatFormatting.GREEN)));
                                                                        cmdCtx.getSource().sendSuccess(() -> message,
                                                                                        true);
                                                                        return 1;
                                                                }))));
        }
