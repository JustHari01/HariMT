...
/**
 * Makes Brain memories map thread-safe and adds null-safety to getMemory().
 * Prevents NPE crashes with mob AI (Villager, Piglin, etc.) during async entity ticking.
 */
@Mixin(Brain.class)
